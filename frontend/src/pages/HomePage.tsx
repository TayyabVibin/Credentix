...
export default function HomePage() {
  ...
  return (
    <Box sx={{ bgcolor: '#0B0F1A', color: '#F1F5F9', minHeight: '100vh', overflow: 'hidden' }}>
      {/* Navbar */}
      <Box
        component="nav"
        sx={{
          ...
          bgcolor: 'rgba(11,15,26,0.75)',
          borderBottom: '1px solid rgba(255,255,255,0.06)',
        }}
      >
        <Container maxWidth="lg">
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', py: 2 }}>
            <Typography variant="h5" fontWeight={800} sx={{ background: 'linear-gradient(135deg, #818CF8 0%, #38BDF8 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Credentix
            </Typography>
      ...
      >
        <Box
          sx={{
            position: 'absolute',
            inset: 0,
            background: 'radial-gradient(ellipse at 50% 0%, rgba(99,102,241,0.15) 0%, transparent 60%), radial-gradient(ellipse at 80% 50%, rgba(56,189,248,0.1) 0%, transparent 50%)',
          }}
        />
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              >
                ...
                <Typography
                  variant="h6"
                  sx={{ color: '#94A3B8', fontWeight: 400, lineHeight: 1.7, mb: 4, maxWidth: 520 }}
                >
                ...
                <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
                  <Button
                    variant="contained"
                    size="large"
                    onClick={() => navigate(isAuthenticated ? '/wallet' : '/register')}
                    sx={{
                      px: 4,
                      py: 1.5,
                      fontSize: '1rem',
                  ...
                  <Button
                    variant="outlined"
                    size="large"
                    onClick={() => navigate(isAuthenticated ? '/wallet' : '/login')}
                    sx={{
                      px: 4,
                      py: 1.5,
                      fontSize: '1rem',
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography
              ...
              textAlign="center"
              sx={{ mb: 8, maxWidth: 600, mx: 'auto', color: '#94A3B8' }}
            >
            ...
            {features.map((f, i) => (
              <Grid size={{ xs: 12, sm: 6 }} key={f.title}>
                ...
                >
                  ...
                  >
                    <Box sx={{ maxWidth: 120, mb: 3 }}>
                      <Lottie animationData={f.animation} loop />
                    </Box>
          ...
          <Grid container spacing={8} alignItems="center">
            <Grid size={{ xs: 12, md: 5 }}>
              <motion.div
                ...
                animate={creditsInView ? { opacity: 1, x: 0 } : {}}
                transition={{ duration: 0.6 }}
              >
                <Box sx={{ maxWidth: 350, mx: { xs: 'auto', md: 0 } }}>
            ...
            <Grid size={{ xs: 12, md: 7 }}>
              ...
              >
                ...
                <Typography variant="body1" sx={{ color: '#94A3B8', mb: 4, lineHeight: 1.8, maxWidth: 540 }}>
                  Credits provide a flexible, prepaid consumption model that gives you full control over your spending. Purchase once, use anywhere across the platform — with complete transparency and no surprises.
                </Typography>
              </motion.div>
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography
              variant="h6"
              textAlign="center"
              sx={{ color: '#94A3B8', mb: 8, maxWidth: 500, mx: 'auto' }}
            >
              Built for reliability at scale with enterprise-grade monitoring.
            </Typography>
          </motion.div>
        ...
        <Container maxWidth="sm" sx={{ position: 'relative' }}>
          ...
          >
            ...
            <Typography variant="h6" sx={{ color: '#94A3B8', mb: 5 }}>
              Join Credentix and experience premium payment infrastructure.
            </Typography>
            <Button
              variant="contained"
              size="large"
        ...
        <Container maxWidth="lg">
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
            <Typography variant="body2" sx={{ color: '#64748B' }}>
              {new Date().getFullYear()} Credentix. All rights reserved.
            </Typography>
            <Typography
              variant="body2"
              sx={{
