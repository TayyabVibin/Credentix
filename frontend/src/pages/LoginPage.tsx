        ...
        >
          <Box sx={{ flex: 1, display: { xs: 'none', md: 'block' } }}>
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
              <Box sx={{ maxWidth: 360 }}>
                <Lottie animationData={gatewayAnim} loop />
              </Box>
              <Typography variant="h5" fontWeight={700} sx={{ color: '#F1F5F9', mt: 3, mb: 1 }}>
                Welcome back to Credentix
              </Typography>
              <Typography variant="body2" sx={{ color: '#94A3B8', lineHeight: 1.7 }}>
                Manage your credits, process payments, and monitor transactions — all from one dashboard.
              </Typography>
            </motion.div>
          </Box>
              ...
              <CardContent sx={{ p: 4 }}>
                ...
                <form onSubmit={handleSubmit}>
                  <TextField
                    ...
                    slotProps={{
                      input: {
                        startAdornment: <InputAdornment position="start"><EmailRounded sx={{ color: '#64748B' }} /></InputAdornment>,
                      },
                    }}
                    sx={{ mb: 2.5 }}
                  />
                ...
                <Typography sx={{ mt: 3, textAlign: 'center' }} variant="body2">
                  ...
                  <Link component={RouterLink} to="/register" underline="hover" fontWeight={600} sx={{ color: '#818CF8' }}>
                    Sign up
                  </Link>
                </Typography>
              </CardContent>
